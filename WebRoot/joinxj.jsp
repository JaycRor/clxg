...
<div class="yc-txdd">
    <div class="yc-mbx"  >
        <p>当前位置：<a href="index.jsp" class="ll">丛林闲居网</a> &gt; <a href="joinxj.jsp#" class="xz">加盟</a></p>
    </div>
    ...
    <div class="kwff-p1" align="center">
          ...
          <p class="kwff-p12">
          	<a href="joinus.jsp"><span>丛林加盟</span></a> 
          	<span class="qzfze">闲居加盟</span>        
          </p>
     </div>  
     <div class="qzsqb">
     	<div class="qzsqb-one">
     ...
     <div class="jm-left"  align="center">  
     	<p class="xx">
        	<em style="font-size: 10px;color: red">加盟首先要登录哦，点击<a href="login.jsp?returnurl=/joinxj.jsp">登录</a><br></em>
        ...
        <form method="post" action="http://172.16.42.192:8080/clxj/joincl!addJoincl.action" id="joinclForm" enctype="multipart/form-data" novalidate="novalidate">
        	<div class="tab"> 
                ...
                <p><input type="text" value="" name="joincl.clname" id="name" placeholder="酒店名称" class="lxr"><i>*</i><span class="status" style="color: red" id="td1"></span><span class="status" style="color: red" id="td1"></span></p>
                <p><input type="text" value="" name="joincl.permitno" id="permitno" placeholder="酒店场所许可证号" class="lxr "><i>*</i><span class="status" style="color: red" id="td1"></span><span class="status" style="color: red" id="td2"></span></p>
                ...
                <p><input type="text" id="mobileYZM" placeholder="验证码" maxlength="6" onblur="checkYZM()" class="yzm"> 
               	...
               	<p><textarea name="joincl.message" placeholder="酒店的简要介绍（500字以内）："></textarea></p>                
