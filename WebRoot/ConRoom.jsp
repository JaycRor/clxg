...
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <title>丛林闲居</title>
    <script src="./chanhui_file/hm.js.下载"></script><script type="text/javascript" src="./chanhui_file/jquery.min.js.下载"></script>
    <link rel="stylesheet" href="./chanhui_file/cy.css">
    <link rel="stylesheet" href="./chanhui_file/style.css">
...
<div class="index-top">
    ...
    <div class="left"> 
        <span class="one"><a href="http://www.3wcl.com/"><img width="158" height="64" src="./chanhui_file/logo1.png"></a></span>
        <span class="two"><img src="./chanhui_file/index_q.png"></span>

        <div class="three"> 
            <span><img src="./chanhui_file/index_03.png"></span>
            <ul>
    ...
    <div class="right">
        <p class="one"><img src="./chanhui_file/index_06.jpg"></p>
        <p class="two"><img src="./chanhui_file/e_03.jpg"></p> 
        <p class="three none"><img width="104" height="105" src="./chanhui_file/weixin.png"></p>
    </div> 
    </div> 
</div>
<!--首页banner-->
...
function loginOut(){
	window.location.href = "/clxj/reguser!loginOut.action?returnurl=/ConEntryPage.jsp";
}
</script>
<!--用车-填写订单-->
...
<div class="index-lbt"> 
 	<div class="yc-mbx">
          <p>当前位置：<a href="index.jsp" class="ll">丛林闲居网</a> &gt; <a href="chanhui.jsp" class="xz">忏悔</a></p>
    </div>    
    <div class="yc-txdd">
        <div class="ch-chs">
            <div class="ch-main">
                ...
                <div class="ch-nr">
                    <div class="ch-one"> 
                   		 <div align="center"> 
                   		 	<form action="confe!addConfession.action" method="post" id="confessionForm">
                   				 <textarea id="content" name="confession.content"  onfocus="if(value=='请在此处输入忏悔'){value=''}"  onblur="if (value ==''){value='请在此处输入忏悔'}" style="width: 700px;height: 300px; margin-left: -50px;">请在此处输入忏悔</textarea><br/><br/>
                       		 	 <input id="subCon" type="submit" value="提交忏悔" class="tjch" >
                        ...
                        <div class="container" style="margin-top: 0px;margin-left: -220px;" align="left">
								<div class="row">
									<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="height: 100px;">
										...
										<!-- =============================================================================================================== -->
										<script type="text/javascript"
											src="/clxj/record/js/swfobject.js"></script>
										<script type="text/javascript"
											src="/clxj/record/js/recorder.js"></script>
										<script type="text/javascript"
											src="/clxj/record/js/main.js"></script>
										<link rel="stylesheet" href="/clxj/record/style.css">
										<div class="qcontainer" id="myRecordDiv">
											...
											<div class="details">
												...
												<span id="save_button" style="display: inline-block;">
													<object data="/clxj/record/recorder.swf"
														name="recorderApp" id="recorderApp"
														type="application/x-shockwave-flash" height="24"
														width="24">
														<param
															value="upload_image=/clxj/record/images/upload.png"
															name="flashvars">
													</object>
												</span>
											...
											<!-- 这个form的action写上传路径 -->
											<form id="uploadForm" name="uploadForm" action="/clxj/confessiondupload">
...
<div class="tcc none" id="okok">
    <div class="cgxd3">
        <div class="cgxd-main">
            <p class="xdcg"><img src="./chanhui_file/chanhuiwen.png"></p>
            <p class="ddbh"><em id="pwd"></em></p>  
           <!--  <p class="fhdd"><a href="ConEntryPage.jsp" class="fh">返回忏悔首页</a>（牢记上10位数字码，方便您阅读解脱文）</p> -->
            <p class="fhdd"><a href="ConRoom.jsp" class="fh">返回忏悔首页</a>（牢记上10位数字码，方便您阅读解脱文）</p>
        </div>
    </div>
</div>
<script type="text/javascript">
	...
	//跳到忏悔主页面 
	function goPage(){
	/* 	window.location.href ="/clxj/ConEntryPage.jsp";  */
		window.location.href ="/conglin/chanhui.jsp";
		}
</script>
...
<div class="yj">
   ...
   <div class="yj-right">
    	<div class="yr-one">
            <img src="./chanhui_file/weixin.png" width="94" height="94">
            <p>微信平台</p>
        </div> 
        <div class="yr-one">
             <img src="./chanhui_file/clxj.png" width="94" height="94">
             <p>丛林/闲居管理者APP下载</p>
        </div>
        <div class="yr-one"> 
            <img src="./chanhui_file/car.png" width="94" height="94">
            <p>司机用车APP</p>
        </div>
        <div class="yr-one"> 
             <img src="./chanhui_file/orderclxj.png" width="94" height="94">
             <p>订房APP下载</p>  
        </div>  
    </div>
    </div>
...
<footer>
    <ul>
        ...
        <li>Copyright © 2105 <a href="http://172.16.42.192:8080/clxj/ConEntryPage.jsp#">丛林闲居</a>  版权所有 3wcl.com | 客服中心：400-688-6798</li>
    </ul>
    <p><a href="http://172.16.42.192:8080/clxj/ConEntryPage.jsp#"><img src="./chanhui_file/index_48.jpg"></a><a href="http://172.16.42.192:8080/clxj/ConEntryPage.jsp#"><img src="./chanhui_file/index_50.jpg"></a><a href="http://172.16.42.192:8080/clxj/ConEntryPage.jsp#"><img src="./chanhui_file/index_52.jpg"></a> <a href="http://172.16.42.192:8080/clxj/ConEntryPage.jsp#"><img src="./chanhui_file/index_54.jpg"></a><a href="http://172.16.42.192:8080/clxj/ConEntryPage.jsp#"><img src="./chanhui_file/index_56.jpg"></a> <a href="http://172.16.42.192:8080/clxj/ConEntryPage.jsp#"><img src="./chanhui_file/index_58.jpg"></a>    </p>
</footer>


    </div>
<div class="tcc none" style="height: 1298px;">
    <div class="tx-ydm">
    		<form action="http://172.16.42.192:8080/clxj/free!selFreeOfPwd.action" method="post" id="myForm">
            <p class="tx-sm"><span class="one"><img src="./chanhui_file/tx.png">提示</span><span class="two"><img src="./chanhui_file/14_01.png" class="close2"></span></p><br><br><br>
            <p></p><div style="text-align: center;color: red;" id="message"><input type="hidden" id="hidden"></div><p></p>
...
<script type="text/javascript">
	function checkPwd(){
		...
		if (valid) {
			$.post("/clxj/free!checkPwd.action",
				  {"confession.pwd":pwd},
				  function(result){
					  if(result == null){
...
<script src="./chanhui_file/index.js.下载"></script>
