...
<div class="index-lbt"> 
 	<div class="yc-mbx">
          <p>当前位置：<a href="conglin.jsp" class="ll">丛林闲居网</a> &gt; <a href="chanhui.jsp" class="xz">忏悔</a></p>
    </div>    
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
		...
		<div class="carousel-inner">
			<div id="pic0" class="item active">
				<img src="./chanhui_file/chanhui01.png">
			</div>
			<div id="pic1" class="item">
				<img src="./chanhui_file/chanhui02.png">
			</div> 
			<div id="pic2" class="item">
				<img src="./chanhui_file/chanhui03.png">
			</div>
			<div id="pic3" class="item">
				<img src="./chanhui_file/chanhui04.png">
			</div>
			<div id="pic4" class="item">
				<img src="./chanhui_file/chanhui05.png">
			</div>
		</div>
		<!-- 轮播（Carousel）导航 -->
...
<div class="tcc none" style="height: 1298px;">
    <div class="tx-ydm">
            ...
            <p class="tx-sm"><span class="one"><img src="./chanhui_file/tx.png">提示</span><span class="two"><a href="chanhui.jsp" ><img src="./chanhui_file/14_01.png" class="close2"></a></span></p><br><br><br>
