...
<body>
		...
		<div id="TitleArea_Title">
			<div id="TitleArea_Title_Content">
				<img border="0" width="13" height="13"
					src="detail/style/images/title_arrow.gif" /> 闲居列表
			</div>
		</div>
	...
	<div id="QueryArea">
		<form action="/wirelessplatform/cuisine.html" method="get">
			...
			<input type="text" name="keyword" title="请输入闲居名称">
	...
	<div id="MainArea">
		<table class="MainArea_Content" align="center" cellspacing="0" cellpadding="0">
			...
			<!--显示数据列表 -->
			<tbody id="TableData">
				<s:iterator value="temples" var="e" status="status">
					<tr>
						<td><s:property value="#e.TId" /></td>
						<td><s:property value="#e.TName" /></td>
						<td><s:property value="#e.TLocaltion" /></td>
						<td><s:property value="#e.TNumber" /></td>
						<td><s:property value="#e.TPc" /></td>
						<td><s:property value="#e.TContactorName" /></td>
						<td align="center">
