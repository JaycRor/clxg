	    ...
	    <li class="level1">
            ...
            <ul class="MenuLevel2">
            	...
            	<li class="level2 level2Style">
                    <a target="right" href="${ pageContext.request.contextPath }/user_findAllUser.action">用户管理</a>
                    
				</li>
				<br><br>
                <li class="level2 level2Style">
                	<a target="right" href="${ pageContext.request.contextPath }/temple_findAllTemple.action">闲居管理</a>
				</li>
				<br><br>
                <li class="level2 level2Style">
                	<a target="right" href="${ pageContext.request.contextPath }/hotel_findAllHotel.action">丛林管理</a>
				</li>
				<br><br>
                <li class="level2 level2Style">
                	<a target="right" href="${ pageContext.request.contextPath }/monk_findAllMonk.action">僧侣管理</a>
				</li>
            </ul>
        </li>
    </ul>
