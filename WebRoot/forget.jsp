...
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  <title>丛林闲居</title>
    <link rel="stylesheet" href="./forget_file/cy.css">
    <link rel="stylesheet" href="./forget_file/style.css">
<style type="text/css" abt="234"></style><script src="./forget_file/hm.js.下载"></script><script>//console.log('a')
...
<div class="index-top">
    ...
    <div class="left"> 
        <span class="one"><a href="http://www.3wcl.com/"><img width="158" height="64" src="./forget_file/logo1.png"></a></span>
        <span class="two"><img src="./forget_file/index_q.png"></span>

        <div class="three"> 
            <span><img src="./forget_file/index_03.png"></span>
            <ul>
    ...
    <div class="right">
        <p class="one"><img src="./forget_file/index_06.jpg"></p>
        <p class="two"><img src="./forget_file/e_03.jpg"></p> 
        <p class="three none"><img width="104" height="105" src="./forget_file/weixin.png"></p>
    </div> 
    </div> 
</div>
<!--首页banner-->
<div class="index-banner">
    ...
    <ul>
        <li><a href="http://www.3wcl.com/">首页</a></li> 
        <li><a href="http://172.16.42.192:8080/clxj/clxjmain!selClOfPage.action?clxjmain.type2=true">丛林</a></li>
        <li><a href="http://172.16.42.192:8080/clxj/clxjmain!selXjOfPage.action?clxjmain.type2=false">闲居</a></li>
        <li><a href="http://172.16.42.192:8080/clxj/ConEntryPage.jsp">忏悔</a></li>
        <li><a href="http://172.16.42.192:8080/clxj/FoundIndex.jsp">基金会</a></li>
        <li><a href="http://172.16.42.192:8080/clxj/joincl.jsp">加盟</a></li>
        <li><a href="http://172.16.42.192:8080/clxj/ContactUs.jsp">联系我们</a></li> 
        <li><a href="http://172.16.42.192:8080/clxj/clsz.jsp">丛林素斋</a></li>
    </ul> 
    
    	<div class="dl"><a href="http://172.16.42.192:8080/clxj/RetrievePassword.jsp#" onclick="Alllogin()">登录</a><i>|</i><a href="http://172.16.42.192:8080/clxj/register.jsp">注册</a></div>
...
function loginOut(){
	window.location.href = "/clxj/reguser!loginOut.action?returnurl=/login.jsp";
}
 </script>
        <!--首页轮播图-->
        ...
        <div class="passwrod-seek-i seek-top" id="div1">
            ...
            <ul class="seek-i">
                ...
                <li class="seek-i-three">验证码<input maxlength="4" type="text" id="yzm" onblur="checkYZM()"><img id="yzmImg" style="margin-left: 10px" width="101" height="36" src="./forget_file/reguser!exyzmStr.action"><a href="javascript:void(0)" style="cursor:hand" class="pwa-pro" onclick="changeYzm()">换一换</a><span style="margin-left: 10px;color: red;" id="span3"></span></li>
...
<div class="yj">
   ...
   <div class="yj-right">
    	<div class="yr-one">
            <img src="./forget_file/weixin.png" width="94" height="94">
            <p>微信平台</p>
        </div> 
        <div class="yr-one">
             <img src="./forget_file/clxj.png" width="94" height="94">
             <p>丛林/闲居管理者APP下载</p>
        </div>
        <div class="yr-one"> 
            <img src="./forget_file/car.png" width="94" height="94">
            <p>司机用车APP</p>
        </div>
        <div class="yr-one"> 
             <img src="./forget_file/orderclxj.png" width="94" height="94">
             <p>订房APP下载</p>  
        </div>  
    </div>
    </div>
...
<footer>
    <ul>
        ...
        <li>Copyright © 2105 <a href="http://172.16.42.192:8080/clxj/RetrievePassword.jsp#">丛林闲居</a>  版权所有 3wcl.com | 客服中心：400-688-6798</li>
    </ul>
    <p><a href="http://172.16.42.192:8080/clxj/RetrievePassword.jsp#"><img src="./forget_file/index_48.jpg"></a><a href="http://172.16.42.192:8080/clxj/RetrievePassword.jsp#"><img src="./forget_file/index_50.jpg"></a><a href="http://172.16.42.192:8080/clxj/RetrievePassword.jsp#"><img src="./forget_file/index_52.jpg"></a> <a href="http://172.16.42.192:8080/clxj/RetrievePassword.jsp#"><img src="./forget_file/index_54.jpg"></a><a href="http://172.16.42.192:8080/clxj/RetrievePassword.jsp#"><img src="./forget_file/index_56.jpg"></a> <a href="http://172.16.42.192:8080/clxj/RetrievePassword.jsp#"><img src="./forget_file/index_58.jpg"></a>    </p>
</footer>
...
<div class="tcc none" id="okok" style="height: 1229px;">
    <div class="cgxd4">
            <div class="cgxd4-top"><p class="one"><img src="./forget_file/zhmm4_03.jpg">提示</p><p class="two"><img src="./forget_file/14_01.png" class="close3"></p></div>
...
<script src="./forget_file/jquery.min.js.下载"></script>
<script src="./forget_file/index.js.下载"></script>
<script type="text/javascript">
...
var wait=120;//倒计时获取验证码时间
	...
	function checkPhone(){
		...
		if(!phoneNumCheck){
			...
			$.ajax({  
		        type : "post",  
		         url : "/clxj/reguser!checkMobile.action",  
	...
	//改变图形验证码
	function changeYzm(){
		$("#yzmImg").attr("src","/clxj/reguser!exyzmStr.action?x=" + Math.random());
			}
	//检验图形验证码
	function checkYZM(){
		var yzm = $('#yzm').val();
		...
		/* if(yzm.length<4){
			...
			span3.innerHTML="请输入正确的验证码格式";
				...
				$.ajax({  
			        type : "post",  
			         url : "/clxj/reguser!checkLoginYZM.action",  
			         data: {"YZM":yzm}, 
			         dataType: "json",
			         async : false,   
			         success : function(results){  
	...
	function getNumRandom(){
		...
		var phone = $('#phone').val();
		$.post("/clxj/reguser!getNumRandom.action",
	...
	function checkphoneYZM(){
		...
		if(phoneYZM==""){
			...
			$.post("/clxj/reguser!checkYZM.action",
	...
	function czpwd(){
		...
		if(checks){
			var repwd = $('#repwd').val(); 
			var phone = $('#phone').val(); 
			$.post("/clxj/reguser!updateUser.action",
					  {"reguser.pwd":repwd,"reguser.username":phone,"retrievePwd":1},
					  function(result){
						  if(result == null){
							  alert("发生了未知错误，我们感到十分抱歉,请重试");
							  window.location.href = "/clxj/RetrievePassword.jsp";
						  }
						  if(result.status=="true"||result.status==true){
	...
	//跳到登录页面
	function goLogin(){
		window.location.href ="/clxj/login.jsp"; 
		}
</script>
