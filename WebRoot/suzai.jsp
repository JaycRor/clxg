...
<!-- saved from url=(0039)http://172.16.42.192:8080/clxj/clsz.jsp -->
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">

<title>丛林闲居-丛林素斋</title>
<link rel="stylesheet" href="./suzai_file/cy.css">
<link rel="stylesheet" href="./suzai_file/style.css">
<style type="text/css" abt="234"></style><script src="./suzai_file/hm.js.下载"></script><script>//console.log('a')
...
<div class="left"><span class="one"><a href="http://www.3wcl.com/"><img width="131" height="52" src="./suzai_file/logo2.png"></a></span> <span class="two"><img src="./suzai_file/index_q.png"></span>

<div class="three"><span><img src="./suzai_file/index_03.png"></span>
<ul>
...
<ul>
	<li>
	<p class="p2" style="text-align: center; font-size: 25px;margin-left: -700px;">丛林素斋理念</p>
	<p class="p1" style="text-align: center; font-size: 20px;">我行我素&nbsp;&nbsp;&nbsp; 戒杀放生</p>
	<p class="p1" style="text-align: center; font-size: 20px;">丛林素斋&nbsp;&nbsp;&nbsp; 佛缘渊源</p>
		<div style="text-align: left; font-size: 15px;margin-top: 10px;margin-left: 400px;">
			<p style="margin-left: 100px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;《涅槃经》中，“佛说：吃肉的人断大</p> 
			<p style="margin-left: 100px;">慈悲种子。” 断大慈悲种子就是丧失爱心。</p>
			<p style="margin-left: 100px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;众多的贤者在谈到爱心时。无不强调要爱一切事物，要爱</p>
			<p style="margin-left: 100px;">一切动物，要对动物有仁慈之心。这与观世音菩萨的“与众</p>
			<p style="margin-left: 100px;">生同一悲仰”的精神是一致的。</p>
			<p style="margin-left: 100px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;无论你是为了持戒或者其他原因而食素，开始的时候是被</p>
			<p style="margin-left: 100px;">动的、从众的。食素时久，爱心日深。</p> 
			<p><img style="margin-top: 10px;" src="./suzai_file/wx1.jpg"></p>
		</div>
	</li>
	<li>
		<div style="text-align: left; font-size: 15px;margin-top: 10px;margin-left: 400px;">
			<p style="margin-left: 100px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;“我不吃肉可以获取所需要的蛋白质吗？</p>
			<p style="margin-left: 100px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;“素食是否可以提供足够的蛋白质呢？”答案是：“是的，</p>
			<p style="margin-left: 100px;">没问题。丛林素斋的食材主要分为高纤维蒟篛制品、大豆蛋</p>
			<p style="margin-left: 100px;">白制品、小麦蛋白制品、香菇制品、素食调味酱料等系列近</p>
			<p style="margin-left: 100px;">300个品种，以室温或冷冻两种储存方式保存。注重饮食健</p>
			<p style="margin-left: 100px;">康，兼顾营养美味。</p>
			<p><img style="margin-top: 10px;" src="./suzai_file/wx2.jpg"></p>
		</div>
	</li>
	<li>
		<div style="text-align: left; font-size: 15px;margin-top: 10px;margin-left: 400px;">
			<p style="margin-left: 100px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;现代的饮食潮流趋向健康的素食，大体说来，素食具有</p>
			<p style="margin-left: 100px;">降低血脂、降低血糖、降低血压、降低胆固醇等功效，还有高</p>
			<p style="margin-left: 100px;">纤维、低热量等特点。对现代人特别是都市人普遍存在的“四</p>
			<p style="margin-left: 100px;">高”，即高血脂、高血糖、高胆固醇、高血压，素食正在成</p>
			<p style="margin-left: 100px;">为一种时尚。同时还专门设有儿童素斋，为糖粘病患者专供</p>
			<p style="margin-left: 100px;">无蔗糖素斋。</p>
			<p style="margin-left: 100px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;自然界物种丰富，素食原料也丰常繁多，这为我们进行素</p>
			<p style="margin-left: 100px;">食烹饪的创作提供前提。丛林素斋将素食与美食巧妙地结</p>
			<p style="margin-left: 100px;">合。</p> 
			<p style="margin-top: 10px;"><img src="./suzai_file/wx3.jpg"></p>
		</div> 
	</li>
	<li>
		<div style="text-align: left; font-size: 15px;margin-top: 10px;margin-left: 560px;">
			<p>详情添加微信公众号：CHAN-3WCL</p>
			<p><img style="margin-top: 10px;margin-left: 20px;" src="./suzai_file/clszwx.jpg" height="200px;" width="200px;"></p>
		</div>
	</li>
</ul>
</div>
...
<div class="yj">
   ...
   <div class="yj-right">
    	<div class="yr-one">
            <img src="./suzai_file/weixin.png" width="94" height="94">
            <p>微信平台</p>
        </div> 
        <div class="yr-one">
             <img src="./suzai_file/clxj.png" width="94" height="94">
             <p>丛林/闲居管理者APP下载</p>
        </div>
        <div class="yr-one"> 
            <img src="./suzai_file/car.png" width="94" height="94">
            <p>司机用车APP</p>
        </div>
        <div class="yr-one"> 
             <img src="./suzai_file/orderclxj.png" width="94" height="94">
             <p>订房APP下载</p>  
        </div>  
    </div>
    </div>
...
<footer>
    <ul>
        ...
        <li>Copyright © 2105 <a href="http://172.16.42.192:8080/clxj/clsz.jsp#">丛林闲居</a>  版权所有 3wcl.com | 客服中心：400-688-6798</li>
    </ul>
    <p><a href="http://172.16.42.192:8080/clxj/clsz.jsp#"><img src="./suzai_file/index_48.jpg"></a><a href="http://172.16.42.192:8080/clxj/clsz.jsp#"><img src="./suzai_file/index_50.jpg"></a><a href="http://172.16.42.192:8080/clxj/clsz.jsp#"><img src="./suzai_file/index_52.jpg"></a> <a href="http://172.16.42.192:8080/clxj/clsz.jsp#"><img src="./suzai_file/index_54.jpg"></a><a href="http://172.16.42.192:8080/clxj/clsz.jsp#"><img src="./suzai_file/index_56.jpg"></a> <a href="http://172.16.42.192:8080/clxj/clsz.jsp#"><img src="./suzai_file/index_58.jpg"></a>    </p>
</footer>


<script src="./suzai_file/jquery.min.js.下载"></script>
<script src="./suzai_file/index.js.下载"></script>
