...
<div class="index-banner">
    ...
    <s:else>
    	<div class="dl"><a href="user.html" >我的订单</a><i>|</i><a href="login.jsp">退出</a></div>
    </s:else>
...
function loginOut(){
	window.location.href = "/clxj/reguser!loginOut.action?returnurl=/FoundIndex.jsp";
        ...
        <div class="yc-txdd">
            <div class="yc-mbx">
                <p>当前位置：<a href="index.jsp" class="ll">丛林闲居网</a> &gt; <a href="index.jsp" class="xz">首页</a></p>
            </div>
            <!-- <div><img src="./index_css/jjh_03.jpg"></div> -->
...
<div class="lby-xy">
    ...
    <div class="lby-xy">
        <div class="lby-left">
            <a href="http://172.16.42.192:8080/clxj/clxjmain!selClxjOfId.action?clxjmain.id=8"><img width="296" height="188" src="./xianju_file/yindu.jpg"></a>
        </div>
        <div class="lby-right">
