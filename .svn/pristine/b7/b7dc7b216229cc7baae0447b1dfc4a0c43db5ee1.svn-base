...
<div id="MainArea">
    <table class="MainArea_Content" cellspacing="0" cellpadding="0">
		...
		<!--显示数据列表 -->
        <tbody id="TableData">
		<s:iterator value="orders" var="e" status="status">
			<tr class="TableDetail1">
				<td align="center"><s:property value="#e.id" /></td>
				<td align="center"><s:property value="#e.number" /></td>
				<td align="center"><s:property value="#e.businessName" /></td>
				<td align="center"><s:property value="#e.time" /></td>
				<td align="center"><s:property value="#e.payWay" /></td>
				<td>
				</td>
			</tr>
        </s:iterator>
