...
<!--首页轮播图-->
 <div class="index-lbt"> 
 	<div class="yc-mbx">
          <p>当前位置：<a href="http://172.16.42.192:8080/clxj/index.jsp" class="ll">丛林闲居网</a> &gt; <a href="http://172.16.42.192:8080/clxj/FoundIndex.jsp#" class="xz">闲居</a></p>
    </div>    
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
		...
		<div class="carousel-inner">
			<div id="pic0" class="item active">
				<img src="./xianju_file/hotel01.png">
			</div>
			<div id="pic1" class="item">
				<img src="./xianju_file/hotel02.png">
			</div> 
			<div id="pic2" class="item">
				<img src="./xianju_file/hotel03.png">
			</div>
			<div id="pic3" class="item">
				<img src="./xianju_file/hotel04.png">
			</div>
			<div id="pic4" class="item">
				<img src="./xianju_file/hotel05.png">
			</div>
		</div>
		<!-- 轮播（Carousel）导航 -->
            ...
            <div class="lbttj">
                ...
                <div class="tj-bottom">
                    <div class="xj">
                     <form action="http://172.16.42.192:8080/clxj/clxjmain!selXjOfPage.action" method="post" onsubmit=""> 
                        <table>
                            ...
                            <tr>
                                <td>入住</td>
                                <td><p><input name="startTime" class="laydate-icon" id="demo1" value="2017-09-23">
                                </p>

                                    <p>退房<input name="endTime" class="laydate-icon" id="demo2" value="2017-09-24">
                                    </p></td>
                            </tr>
                            <tr>  
                                <td>关键词</td>
                    ...
                    <table>
                        ...
                        <tr>
                            <td>入住</td>
                            <td><p><input name="startTime" class="laydate-icon" id="demo3" value="2017-09-23">
                            </p>

                                <p>退房<input name="endTime" class="laydate-icon" id="demo4" value="2017-09-24">
                                </p></td> 
                        </tr>
                        <tr> 
                            <td>关键词</td>
                ...
                <div id="pop_city_ones" class="pop_city" style="display: none; top: 105px; left: 80px;"><p class="pop_head">请选择城市或输入城市名称的拼音或英文</p><ul class="list_label"><li><a id="label_ones1" class="current" href="javascript:void(0)">热门城市</a></li><li><a id="label_ones2" href="javascript:void(0)">A-F</a></li><li><a id="label_ones3" href="javascript:void(0)">G-J</a></li><li><a id="label_ones4" href="javascript:void(0)">K-N</a></li><li><a id="label_ones5" href="javascript:void(0)">O-W</a></li><li><a id="label_ones6" href="javascript:void(0)">X-Z</a></li></ul><div class="pop_city_container"><ul id="label_ones1_container" class="current" data-type="热门城市"><li><a href="javascript:void(0)" data-wholename="bali">巴黎</a></li><li><a href="javascript:void(0)" data-wholename="xian">西安</a></li><li><a href="javascript:void(0)" data-wholename="shangrao">上饶</a></li><li><a href="javascript:void(0)" data-wholename="beijin">北京</a></li><li><a href="javascript:void(0)" data-wholename="ganzhou">赣州</a></li></ul><ul style="display:none" id="label_ones2_container" data-type="A-F"><li><a href="javascript:void(0)" data-wholename="bali">巴黎</a></li><li><a href="javascript:void(0)" data-wholename="bali">巴黎</a></li><li><a href="javascript:void(0)" data-wholename="beijin">北京</a></li></ul><ul style="display:none" id="label_ones3_container" data-type="G-J"><li><a href="javascript:void(0)" data-wholename="ganzhou">赣州</a></li></ul><ul style="display:none" id="label_ones4_container" data-type="K-N"><li><a href="javascript:void(0)" data-wholename="nanchang">南昌</a></li></ul><ul style="display:none" id="label_ones5_container" data-type="O-W"><li><a href="javascript:void(0)" data-wholename="shangrao">上饶</a></li><li><a href="javascript:void(0)" data-wholename="shanghai">上海</a></li></ul><ul style="display:none" id="label_ones6_container" data-type="X-Z"><li><a href="javascript:void(0)" data-wholename="xian">西安</a></li></ul></div></div><div id="suggest_city_ones" class="list_city" style="display: none; top: 105px; left: 80px;"><div class="list_city_head"></div><div class="list_city_container"></div><div class="page_break"></div></div><div id="pop_city_oness" class="pop_city" style="display: none; top: 105px; left: 80px;"><p class="pop_head">请选择城市或输入城市名称的拼音或英文</p><ul class="list_label"><li><a id="label_oness1" class="current" href="javascript:void(0)">国际城市</a></li></ul><div class="pop_city_container"><ul id="label_oness1_container" class="current" data-type="国际城市"><li><a href="javascript:void(0)" data-wholename="bali">巴黎</a></li><li><a href="javascript:void(0)" data-wholename="bali">巴黎</a></li></ul></div></div><div id="suggest_city_oness" class="list_city" style="display: none; top: 105px; left: 80px;"><div class="list_city_head"></div><div class="list_city_container"></div><div class="page_break"></div></div></div>
            </div>
        </div>
    </div>
</div>
<div class="lby">
    ...
    <div class="lby-xy">
        <div class="lby-left">
            <a href="http://172.16.42.192:8080/clxj/clxjmain!selClxjOfId.action?clxjmain.id=6"><img width="296" height="188" src="./xianju_file/xj01.jpg"></a>
        </div>
        <div class="lby-right">
            <p class="title"><a href="http://172.16.42.192:8080/clxj/clxjmain!selClxjOfId.action?clxjmain.id=6">国内酒店一</a></p>
            <p class="con">客房 有 208 间装饰独特的客房提供冰箱和迷你吧；您定能在旅途中找到家的舒适。您的客房备有Select Comfort卧床，配备淋<br>浴/盆浴组合的独立浴室提供免费洗浴用品和吹风机。休闲、SPA、高端服务......</p>
            <p class="address">位  置:海南省海口市</p>
        </div>
        <div class="lby-pos">
            <div>
                <p class="one">
                ...
                <p class="yd">
                    <span class="mony">1199<i>/晚</i></span>
    ...
    <div class="lby-xy">
        <div class="lby-left">
            <a href="http://172.16.42.192:8080/clxj/clxjmain!selClxjOfId.action?clxjmain.id=9"><img width="296" height="188" src="./xianju_file/xj02.jpg"></a>
        </div>
        <div class="lby-right">
            <p class="title"><a href="http://172.16.42.192:8080/clxj/clxjmain!selClxjOfId.action?clxjmain.id=9">国内酒店四</a></p>
            <p class="con">客房 有 297 间装饰独特的客房提供冰箱和迷你吧；您定能在旅途中找到家的舒适。您的客房备有Select Comfort卧床。带有卫<br>星节目的 33 英寸液晶电视可满足您的娱乐需求；同时提供免费无线上网，帮助您与朋友保持联系。</p>
            <p class="address">位  置:广西省北海市</p>
        </div>
        <div class="lby-pos">
            <div>
                <p class="one">
                ...
                <p class="yd">
                    <span class="mony">999<i>/晚</i></span>
    ...
    <div class="lby-xy">
        <div class="lby-left">
            <a href="http://172.16.42.192:8080/clxj/clxjmain!selClxjOfId.action?clxjmain.id=35"><img width="296" height="188" src="./xianju_file/xj03.jpg"></a>
        </div>
        <div class="lby-right">
            <p class="title"><a href="http://172.16.42.192:8080/clxj/clxjmain!selClxjOfId.action?clxjmain.id=35">国内酒店六</a></p>
<p class="con">客房 有 150 间装饰独特的客房提供冰箱和迷你吧；您定能在旅途中找到家的舒适。您的客房备有Select Comfort卧床，配备淋<br>浴/盆浴组合的独立浴室提供免费洗浴用品和吹风机。休闲、SPA、高端服务......</p>            <p class="address">位  置:四川省都江堰市</p>
        </div>
        <div class="lby-pos">
            <div>
                <p class="one">
                ...
                <p class="yd">
                    <span class="mony">199<i>/晚</i></span>
    ...
    <div class="lby-xy">
        <div class="lby-left">
            <a href="http://172.16.42.192:8080/clxj/clxjmain!selClxjOfId.action?clxjmain.id=40"><img width="296" height="188" src="./xianju_file/xj04.jpg"></a>
        </div>
        <div class="lby-right">
            <p class="title"><a href="http://172.16.42.192:8080/clxj/clxjmain!selClxjOfId.action?clxjmain.id=40">国外酒店六</a></p>
            <p class="con">客房 有 316 间装饰独特的客房提供冰箱和迷你吧；您定能在旅途中找到家的舒适。您的客房备有Select Comfort卧床。带有卫<br>星节目的 33 英寸液晶电视可满足您的娱乐需求；同时提供免费无线上网，帮助您与朋友保持联系。</p>
            <p class="address">位  置:孟加拉班多尔班</p>
        </div>
        <div class="lby-pos">
            <div>
                <p class="one">
                ...
                <p class="yd">
                    <span class="mony">849<i>/晚</i></span>
    ...
    <div class="lby-xy">
        <div class="lby-left">
            <a href="http://172.16.42.192:8080/clxj/clxjmain!selClxjOfId.action?clxjmain.id=16"><img width="296" height="188" src="./xianju_file/xj05.jpg"></a>
        </div>
        <div class="lby-right">
            <p class="title"><a href="http://172.16.42.192:8080/clxj/clxjmain!selClxjOfId.action?clxjmain.id=16">国外酒店一</a></p>
<p class="con">客房 有 169间装饰独特的客房提供冰箱和迷你吧；您定能在旅途中找到家的舒适。您的客房备有Select Comfort卧床，配备淋<br>浴/盆浴组合的独立浴室提供免费洗浴用品和吹风机。休闲、SPA、高端服务......</p>            <p class="address">位  置:泰国清莱</p>
        </div>
        <div class="lby-pos">
            <div>
                <p class="one">
                ...
                <p class="yd">
                    <span class="mony">1399<i>/晚</i></span>
    ...
    <div class="lby-xy">
        <div class="lby-left">
            <a href="http://172.16.42.192:8080/clxj/clxjmain!selClxjOfId.action?clxjmain.id=7"><img width="296" height="188" src="./xianju_file/xj06.jpg"></a>
        </div>
        <div class="lby-right">
            <p class="title"><a href="http://172.16.42.192:8080/clxj/clxjmain!selClxjOfId.action?clxjmain.id=7">国外酒店二</a></p>
            <p class="con">客房 有 250 间装饰独特的客房提供冰箱和迷你吧；您定能在旅途中找到家的舒适。您的客房备有Select Comfort卧床。带有卫<br>星节目的 33 英寸液晶电视可满足您的娱乐需求；同时提供免费无线上网，帮助您与朋友保持联系。</p>
            <p class="address">位  置:澳大利亚凯恩斯</p>
        </div>
        <div class="lby-pos">
            <div>
                <p class="one">
                ...
                <p class="yd">
                    <span class="mony">1999<i>/晚</i></span>
    ...
    <div class="lby-xy">
        <div class="lby-left">
            <a href="http://172.16.42.192:8080/clxj/clxjmain!selClxjOfId.action?clxjmain.id=8"><img width="296" height="188" src="./xianju_file/xj07.jpg"></a>
        </div>
        <div class="lby-right">
            <p class="title"><a href="http://172.16.42.192:8080/clxj/clxjmain!selClxjOfId.action?clxjmain.id=8">国内酒店三</a></p>
            <p class="con">客房 有 150 间装饰独特的客房提供冰箱和迷你吧；您定能在旅途中找到家的舒适。您的客房备有Select Comfort卧床，配备淋<br>浴/盆浴组合的独立浴室提供免费洗浴用品和吹风机。休闲、SPA、高端服务......</p>
            <p class="address">位  置:广东省广州市</p>
        </div>
        <div class="lby-pos">
            <div>
                <p class="one">
                ...
                <p class="yd">
                    <span class="mony">2499<i>/晚</i></span>
